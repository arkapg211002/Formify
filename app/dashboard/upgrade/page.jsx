      ...
      <div className="mx-auto max-w-3xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:items-center md:gap-8">
          ...
          {PricingPlan.map((item, index) => (
            <div key={index} className="rounded-2xl border border-gray-200 p-6 shadow-lg sm:px-8 lg:p-12">
              ...
              <a
                ...
                target='_blank'
                className="font-medium mt-8 block rounded-full border border-[#000000] bg-white px-12 py-3 text-center text-sm text-black hover:ring-1 hover:ring-[#E9EBE3] focus:outline-double focus:ring active:text-black hover:font-bold hover:bg-[#E9EBE3]"
              >
                Get Started
              </a>
            </div>
