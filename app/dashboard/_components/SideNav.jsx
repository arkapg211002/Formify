    ...
    <div className='h-screen shadow-lg border'>
        <div className='p-5'>
            {menuList.map((menu,index)=>(
                ...
                hover:bg-secondary hover:text-black rounded-lg
        ...
        <div className='fixed bottom-7 p-6 w-64 '>
            ...
            <h2 className='text-sm mt-2 text-gray-600'><strong>{formList?.length} </strong>Out of <strong>5</strong> File Created</h2>
